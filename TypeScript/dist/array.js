...
//     console.log(element);
// });
const numbers = [2, 3, 4, 5, 7, 8, 2, 1, 3];
...
const names = ["kajal", "kumari", "tiwari"];
const newVersion = names.map((e) => e.toUpperCase());
console.log(names, newVersion);
const exponentialNumbers = numbers.map((El) => El * El);
console.log(exponentialNumbers);
const names2 = ["absdbaiducgddfcjdsbyw", "asdjbtudtgfdsktcw", "askhdgtfdgw", "asjdbyu", "sdjfvtsdf"];
const stri = names2.filter((el) => el.length > 15);
console.log(stri);
